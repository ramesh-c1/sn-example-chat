...
Thank you for your interest in `sn-example-chat`, an open source project
administered by StrongLoop.

Contributing to `sn-example-chat` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/sn-example-chat)
